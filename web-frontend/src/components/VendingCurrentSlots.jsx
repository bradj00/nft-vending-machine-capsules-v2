...
const VendingCurrentSlots = () => {
    ...
    <div style={{}}>
        ...
        <div className="showcase" style={{animation: `animate ${rateOfRotation}s linear infinite`}}>
         ...
         { registeredFromOnChainBySlot[1]? <CarouselNftSlot  contractAddress={'MCPC contract'}  slotContractAddress={NftSlotContractAddresses[0]} slotObj={slot1Obj} contractName={1}  contractSymbol={1}    tokenId={registeredFromOnChainBySlot[1]}  thisStyle={style1}  slotIndex={1}  slotImageUrl={slot1ImageUrl}  NftSlotOdds={NftSlotOdds} slotStock={slot1Stock}  styleEmpty={style1Empty}/> : <CarouselNftSlot thisStyle={style1}  slotIndex={1}  styleEmpty={style1Empty}/> }                   
         { registeredFromOnChainBySlot[2]? <CarouselNftSlot  contractAddress={'MCPC contract'}  slotContractAddress={NftSlotContractAddresses[1]} slotObj={slot2Obj} contractName={1}  contractSymbol={1}    tokenId={registeredFromOnChainBySlot[2]}  thisStyle={style2}  slotIndex={2}  slotImageUrl={slot2ImageUrl}  NftSlotOdds={NftSlotOdds} slotStock={slot2Stock}  styleEmpty={style2Empty}/> : <CarouselNftSlot thisStyle={style2}  slotIndex={2}  styleEmpty={style2Empty}/> }                   
         { registeredFromOnChainBySlot[3]? <CarouselNftSlot  contractAddress={'MCPC contract'}  slotContractAddress={NftSlotContractAddresses[2]} slotObj={slot3Obj} contractName={1}  contractSymbol={1}    tokenId={registeredFromOnChainBySlot[3]}  thisStyle={style3}  slotIndex={3}  slotImageUrl={slot3ImageUrl}  NftSlotOdds={NftSlotOdds} slotStock={slot3Stock}  styleEmpty={style3Empty}/> : <CarouselNftSlot thisStyle={style3}  slotIndex={3}  styleEmpty={style3Empty}/> }                   
         { registeredFromOnChainBySlot[4]? <CarouselNftSlot  contractAddress={'MCPC contract'}  slotContractAddress={NftSlotContractAddresses[3]} slotObj={slot4Obj} contractName={1}  contractSymbol={1}    tokenId={registeredFromOnChainBySlot[4]}  thisStyle={style4}  slotIndex={4}  slotImageUrl={slot4ImageUrl}  NftSlotOdds={NftSlotOdds} slotStock={slot4Stock}  styleEmpty={style4Empty}/> : <CarouselNftSlot thisStyle={style4}  slotIndex={4}  styleEmpty={style4Empty}/> }                   
         { registeredFromOnChainBySlot[5]? <CarouselNftSlot  contractAddress={'MCPC contract'}  slotContractAddress={NftSlotContractAddresses[4]} slotObj={slot5Obj} contractName={1}  contractSymbol={1}    tokenId={registeredFromOnChainBySlot[5]}  thisStyle={style5}  slotIndex={5}  slotImageUrl={slot5ImageUrl}  NftSlotOdds={NftSlotOdds} slotStock={slot5Stock}  styleEmpty={style5Empty}/> : <CarouselNftSlot thisStyle={style5}  slotIndex={5}  styleEmpty={style5Empty}/> }                   
         { registeredFromOnChainBySlot[6]? <CarouselNftSlot  contractAddress={'MCPC contract'}  slotContractAddress={NftSlotContractAddresses[5]} slotObj={slot6Obj} contractName={1}  contractSymbol={1}    tokenId={registeredFromOnChainBySlot[6]}  thisStyle={style6}  slotIndex={6}  slotImageUrl={slot6ImageUrl}  NftSlotOdds={NftSlotOdds} slotStock={slot6Stock}  styleEmpty={style6Empty}/> : <CarouselNftSlot thisStyle={style6}  slotIndex={6}  styleEmpty={style6Empty}/> }                   
         { registeredFromOnChainBySlot[7]? <CarouselNftSlot  contractAddress={'MCPC contract'}  slotContractAddress={NftSlotContractAddresses[6]} slotObj={slot7Obj} contractName={1}  contractSymbol={1}    tokenId={registeredFromOnChainBySlot[7]}  thisStyle={style7}  slotIndex={7}  slotImageUrl={slot7ImageUrl}  NftSlotOdds={NftSlotOdds} slotStock={slot7Stock}  styleEmpty={style7Empty}/> : <CarouselNftSlot thisStyle={style7}  slotIndex={7}  styleEmpty={style7Empty}/> }                   
         { registeredFromOnChainBySlot[8]? <CarouselNftSlot  contractAddress={'MCPC contract'}  slotContractAddress={NftSlotContractAddresses[7]} slotObj={slot8Obj} contractName={1}  contractSymbol={1}    tokenId={registeredFromOnChainBySlot[8]}  thisStyle={style8}  slotIndex={8}  slotImageUrl={slot8ImageUrl}  NftSlotOdds={NftSlotOdds} slotStock={slot8Stock}  styleEmpty={style8Empty}/> : <CarouselNftSlot thisStyle={style8}  slotIndex={8}  styleEmpty={style8Empty}/> }                   
         { registeredFromOnChainBySlot[9]? <CarouselNftSlot  contractAddress={'MCPC contract'}  slotContractAddress={NftSlotContractAddresses[8]} slotObj={slot9Obj} contractName={1}  contractSymbol={1}    tokenId={registeredFromOnChainBySlot[9]}  thisStyle={style9}  slotIndex={9}  slotImageUrl={slot9ImageUrl}  NftSlotOdds={NftSlotOdds} slotStock={slot9Stock}  styleEmpty={style9Empty}/> : <CarouselNftSlot thisStyle={style9}  slotIndex={9}  styleEmpty={style9Empty}/> }                   
         { registeredFromOnChainBySlot[10]? <CarouselNftSlot  contractAddress={'MCPC contract'}  slotContractAddress={NftSlotContractAddresses[9]} slotObj={slot10Obj} contractName={1}  contractSymbol={1}    tokenId={registeredFromOnChainBySlot[10]}  thisStyle={style10}  slotIndex={10}  slotImageUrl={slot10ImageUrl}  NftSlotOdds={NftSlotOdds} slotStock={slot10Stock}  styleEmpty={style10Empty}/> : <CarouselNftSlot thisStyle={style10}  slotIndex={10}  styleEmpty={style10Empty}/> }                   
